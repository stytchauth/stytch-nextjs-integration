...
const EML_REDIRECT = '/recipes/api-sms-remembered-device-integrated/magic-link-authenticate';

const RememberedDeviceIntegrated = () => {
...
export default RememberedDeviceIntegrated;
