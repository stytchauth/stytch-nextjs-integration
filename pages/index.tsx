...
const REDIRECT_URL_BASE = process.env.USE_VERCEL ? 'http://localhost:3000/api/authenticate_magic_link' : `https://${process.env.VERCEL_URL}/api/authenticate_magic_link`;
